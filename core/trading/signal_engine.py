...
# --- runtime hotfix patches ---
try:
    import core.trading.signal_engine_patch1 as _patch1
    _patch1.apply_patch(sys.modules[__name__])
except Exception:
    pass
try:
    import core.trading.signal_engine_patch2_yf as _patch2
    _patch2.apply_patch(sys.modules[__name__])
except Exception:
    pass
# --- end patches ---
