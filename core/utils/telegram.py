...
try:
    from core.utils.env_keys import TELEGRAM_TOKEN, TELEGRAM_CHAT_ID_MAIN, TELEGRAM_CHAT_ID_ALT
except Exception:
...
def send_telegram_message(text: str, chat_id: str | int | None = None, parse_mode: str | None = None, fallback_discover: bool = True) -> bool:
    """
